...
val playTestPlus = "org.scalatestplus.play" %% "scalatestplus-play" % "7.0.0" % "test"
...
def logging = Seq(
  ...
  "org.codehaus.janino" % "janino" % "3.1.10", // conditional logback processing
...
lazy val buildSettings = Defaults.coreDefaultSettings ++ Seq(
  ...
  dependencyOverrides ++= Seq(
    "com.fasterxml.jackson.core" % "jackson-databind" % "2.11.4", // spark needs 2.14.2
    "com.fasterxml.jackson.core" % "jackson-core" % "2.11.4", // spark needs 2.14.2
